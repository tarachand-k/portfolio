export const Bio = {
  ...
  facebook: "https://www.facebook.com/share/aeoof8BW2Yi4CSBA/?mibextid=qi2Omg/",
};
// export const skills = [
//   {
//     title: "Frontend",
...
export const education = [
  ...
  },
  {
    ...
    grade: "75.23%",
    desc: "I completed my class 12 high school education at Guru Nanak Khalsa College, Matunga, where I studied with Science specialization",
    degree: "HSC(XII), Science",
  },
  {
    id: 2,
    img: "/ssc.png",
    school: "Shree Vinod Shuckla High School, Chembur",
    date: "Apr 2017 - Apr 2019",
    grade: "80.60%",
    desc: "I completed my class 10 education at Shree Vinod Shuckla High School, Chembur.",
    degree: "SSC(X)",
  },
];
...
export const projects = [
  {
    ...
    category: "react",
    github: "https://github.com/tarachand-k/the-wild-oasis",
    webapp: "https://the-wild-oasis-tarachand.netlify.app/",
  },
  {
    id: 1,
    title: "Movix App",
    ...
    description:
      "Movix 🍿 is a movie information web app that makes use of the TMDB API (The Movie Database). Developed using React, Redux, and Vite, Movix provides users with extensive information about movies, encompassing plot summaries, cast and crew details, ratings, and more. It implements features such as infinite scrolling, lazy load images, search functionality, error handling, etc.",
    image: "/movix-4.png",
    tags: ["React Js", "sass", "Styled components", "Redux", "TMDB API"],
    category: "react",
    github: "https://github.com/tarachand-k/react-movix",
    webapp: "https://movix-tarachand.vercel.app/",
  },
  {
    id: 2,
    ...
    description:
      "Estate platform is a comprehensive web application built using the MERN stack (MongoDB, Express.js, React, Node.js) along with socket.io for real-time communication. This platform serves as a centralized hub for property listings, connecting buyers, renters, sellers, and agents in a seamless and intuitive manner. Implemented many features such as User Authentication and Authorization, Property Listings, Real-Time Chatting, Interactive Map Integration, etc.",
    image: "estate-1.png",
    tags: [
      "React Js",
      "MongoDb",
      ...
      "sass",
      "prisma",
      "reac router with loaders",

      "Socket.io",
    ],
    category: "ml",
    github: "https://github.com/tarachand-k/mern-estate-app",
    webapp: "https://mern-estate-appp.netlify.app/",
  },
];
